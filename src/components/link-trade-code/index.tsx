...
export default function LinkTradeCode() {
	...
	return (
		<div>
			...
			<p>
				A random link trade code that isn't one of the "version exclusive" trade codes from{" "}
				...
				<table className="my-1">
					<tbody>
						<tr>
							...
							<td className="border-default px-1 font-mono">{linkTradeCodeString?.slice(0, 4)}</td>
						</tr>
						<tr>
							<td className="border-default px-1">8-digit</td>
							<td className="border-default px-1 font-mono">
								{linkTradeCodeString?.slice(0, 4)} {linkTradeCodeString?.slice(4)}
							</td>
						</tr>
					</tbody>
				</table>

...
export default function Stopwatch({
	...
	return (
		<div className="border-default relative m-1 inline-block p-1">
			...
			>
				<span className={firstDisplayCharacter === "0" ? "text-gray-200 dark:text-gray-600" : ""}>
			...
			<div>
				{bars.map((bar) => {
					...
					const barText = times < 1 ? bar.name : `${bar.name} (+${Math.floor(times)})`;

					return (
						<div key={bar.id} className="border-default relative mb-1 border dark:bg-black">
							<div

...
export default function YourPokemon({ yourRaidPokemon, onChange, onDelete }: YourPokemonProps) {
		...
		<div className="border-default m-1 inline-block p-1 align-top">
			...
			<div className="-mx-1 mt-1 block border-t border-t-gray-300 px-1">
				...
				{yourRaidPokemon.mainMoves
					...
					.map((move) => (
						<div className="-ml-1 mt-1 block border-t border-t-gray-300 px-1 pt-1" key={move.id}>
							<div>
								<input
									className="inline-block rounded-r-none"
									type="text"
								...
								<button
									...
									onClick={() => {
										onChange({
											id: yourRaidPokemon.id,
											pokemon: yourRaidPokemon.pokemon,
											mainMoves: yourRaidPokemon.mainMoves.filter((mm) => mm.id !== move.id),
										});
									}}
								>
									X
					...
					onClick={() => {
						onChange({
							...
							mainMoves: yourRaidPokemon.mainMoves.concat({
								...
								damageClass: finalStats.atk > finalStats.spa ? "physical" : "special",
